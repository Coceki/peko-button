module.exports = {
    ui: {
        ...
        stopplay: "再生を停止する",
        helptitle: "遊び方ぺこ?",
        helpcontent: "クリックボタン、ぺこらの声を再生することができますだよ~マルチクリックをサポート、同じボタンを複数回クリックして、エコー効果を作成することもできますぺこ~",
        ...
        betainfo: "こんにちは、このウェブサイトはついに日本語をサポートしました　私の日本語は苦手ぺこ　間違いを見つけた場合は、Githubでお知らせください ありがとうございました",
        info: "兎田ぺこら30万人のYouTubeチャンネル登録者におめでとう",
        developer: "開発者：Coceki",
        credits: "特別な感謝：野兔子同好会 Richard_Al 昭和歌姬夏半首",
        translationCredits: "",
