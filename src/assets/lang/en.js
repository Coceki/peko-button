module.exports = {
    ui: {
        ...
        stopplay: "Stop",
        helptitle: "Help",
        helpcontent: "Click button to play Pekora's lines~ No need to wait for the first line to finish before playing the next one",
        ...
        listempty: "Playlist is Empty peko~",
        resetorder: "Clear the playlist",
        language: "Language",
        orderplaymodehelp: "How to use the playlist",
        developerinfo: "This site is made by fans. We are not related to Hololive Official in any way.",
        repeatmode: "Don't you ever stop!(Loop play)",
        betainfo: "2020/6/11, English translation",
        info: "Congratulation to Usada Pekora, reaching 390k channel subscribers",
        ...
        tips3: "It will play these clips in order peko.",
        pekolanguage: "Pekolang generator",
        beta: "Coming soon",
        gotit: "Got it",
